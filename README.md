...
I'm a Computer Science student building a strong foundation in **data science and
machine learning**. I work end-to-end — from cleaning messy datasets to training
and evaluating models, with a focus on **EDA, statistics, and clear results I can
explain**.

🔭 Currently seeking **data science internships**.
...
|---------|--------------|--------|
| [**ChurnGuard**](https://github.com/BerkeArdaTurk21/ChurnGuard) | Predicts telecom customer churn, comparing 3 models with a focus on precision/recall | Classification |
| [**HousePricer**](https://github.com/BerkeArdaTurk21/HousePricer) | Predicts house prices using Linear, Ridge & Random Forest regression | Regression |
...
I document the methods and findings behind my projects — machine learning
applications and global economic data analysis.
